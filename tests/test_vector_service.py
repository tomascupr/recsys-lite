...
class TestVectorService:
    ...
    def test_get_vector_fallback_to_random(self):
        ...
        with patch("numpy.random.random") as mock_random:
            ...
            vector = vector_service.get_vector(model=mock_model, entity_type=EntityType.ITEM, entity_idx=1)
    ...
    def test_get_user_vector_and_get_item_vector(self):
        ...
        vector_service.get_vector.assert_called_once_with(
            model=mock_model, entity_type=EntityType.USER, entity_idx=1, vector_size=2
        )
        ...
        # Verify the call
        vector_service.get_vector.assert_called_once_with(
            model=mock_model, entity_type=EntityType.ITEM, entity_idx=2, entity_id="item_2", vector_size=3
        )
